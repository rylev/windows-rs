...
#[inline]
pub unsafe fn SysAllocStringLen(strin: ::windows::core::PWSTR, ui: u32) -> BSTR {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn SysAllocStringLen(strin: ::windows::core::PWSTR, ui: u32) -> BSTR;
        }
        ::core::mem::transmute(SysAllocStringLen(::core::mem::transmute(strin), ::core::mem::transmute(ui)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
#[inline]
pub unsafe fn GetProcAddress<'a, Param0: ::windows::core::IntoParam<'a, HINSTANCE>>(hmodule: Param0, lpprocname: ::windows::core::PSTR) -> FARPROC {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn GetProcAddress(hmodule: HINSTANCE, lpprocname: ::windows::core::PSTR) -> FARPROC;
        }
        ::core::mem::transmute(GetProcAddress(hmodule.into_param().abi(), ::core::mem::transmute(lpprocname)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
#[inline]
pub unsafe fn LoadLibraryA(lplibfilename: ::windows::core::PSTR) -> HINSTANCE {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn LoadLibraryA(lplibfilename: ::windows::core::PSTR) -> HINSTANCE;
        }
        ::core::mem::transmute(LoadLibraryA(::core::mem::transmute(lplibfilename)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
#[inline]
pub unsafe fn CreateEventA<'a, Param1: ::windows::core::IntoParam<'a, BOOL>, Param2: ::windows::core::IntoParam<'a, BOOL>>(lpeventattributes: *const SECURITY_ATTRIBUTES, bmanualreset: Param1, binitialstate: Param2, lpname: ::windows::core::PSTR) -> HANDLE {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn CreateEventA(lpeventattributes: *const SECURITY_ATTRIBUTES, bmanualreset: BOOL, binitialstate: BOOL, lpname: ::windows::core::PSTR) -> HANDLE;
        }
        ::core::mem::transmute(CreateEventA(::core::mem::transmute(lpeventattributes), bmanualreset.into_param().abi(), binitialstate.into_param().abi(), ::core::mem::transmute(lpname)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
