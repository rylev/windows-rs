...
#[inline]
pub unsafe fn GetProcAddress<'a, P0>(hmodule: P0, lpprocname: ::windows::core::PCSTR) -> FARPROC
where
    P0: ::std::convert::Into<HINSTANCE>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[inline]
pub unsafe fn CreateEventA<'a, P0, P1>(lpeventattributes: *const SECURITY_ATTRIBUTES, bmanualreset: P0, binitialstate: P1, lpname: ::windows::core::PCSTR) -> ::windows::core::Result<HANDLE>
where
