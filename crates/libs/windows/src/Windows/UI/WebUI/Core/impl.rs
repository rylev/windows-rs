...
impl IWebUICommandBarElement_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknown_Impl, Impl: IWebUICommandBarElement_Impl, const OFFSET: isize>() -> IWebUICommandBarElement_Vtbl {
...
impl IWebUICommandBarIcon_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknown_Impl, Impl: IWebUICommandBarIcon_Impl, const OFFSET: isize>() -> IWebUICommandBarIcon_Vtbl {
