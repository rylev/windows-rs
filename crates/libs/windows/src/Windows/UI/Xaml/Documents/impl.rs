...
impl ITextElementOverrides_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknown_Impl, Impl: ITextElementOverrides_Impl, const OFFSET: isize>() -> ITextElementOverrides_Vtbl {
        unsafe extern "system" fn OnDisconnectVisualChildren<Identity: ::windows::core::IUnknown_Impl, Impl: ITextElementOverrides_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void) -> ::windows::core::HRESULT {
