...
#[cfg(feature = "Win32_Storage_StructuredStorage")]
#[inline]
pub unsafe fn JetCreateIndexA<'a, P0, P1>(sesid: P0, tableid: P1, szindexname: *const i8, grbit: u32, szkey: ::windows::core::PCSTR, cbkey: u32, ldensity: u32) -> i32
where
    P0: ::std::convert::Into<super::StructuredStorage::JET_SESID>,
    P1: ::std::convert::Into<super::StructuredStorage::JET_TABLEID>,
{
...
#[cfg(feature = "Win32_Storage_StructuredStorage")]
#[inline]
pub unsafe fn JetCreateIndexW<'a, P0, P1>(sesid: P0, tableid: P1, szindexname: *const u16, grbit: u32, szkey: ::windows::core::PCWSTR, cbkey: u32, ldensity: u32) -> i32
where
    P0: ::std::convert::Into<super::StructuredStorage::JET_SESID>,
    P1: ::std::convert::Into<super::StructuredStorage::JET_TABLEID>,
{
