...
#[doc = "*Required features: `\"Win32_System_Com_StructuredStorage\"`*"]
#[inline]
pub unsafe fn CoGetInstanceFromFile<'a, P0, P1>(pserverinfo: *const super::COSERVERINFO, pclsid: *const ::windows::core::GUID, punkouter: P0, dwclsctx: P1, grfmode: u32, pwszname: ::windows::core::PCWSTR, presults: &mut [super::MULTI_QI]) -> ::windows::core::Result<()>
where
...
impl IPropertyBag {
    ...
    pub unsafe fn Read<'a, P0>(&self, pszpropname: ::windows::core::PCWSTR, pvar: *mut super::VARIANT, perrorlog: P0) -> ::windows::core::Result<()>
    where
...
impl IPropertyBag2 {
    ...
    #[doc = "*Required features: `\"Win32_System_Com_StructuredStorage\"`*"]
    pub unsafe fn LoadObject<'a, P0, P1>(&self, pstrname: ::windows::core::PCWSTR, dwhint: u32, punkobject: P0, perrlog: P1) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, ::windows::core::IUnknown>>,
...
impl IStorage {
    #[doc = "*Required features: `\"Win32_System_Com_StructuredStorage\"`*"]
    pub unsafe fn CreateStream<'a, P0>(&self, pwcsname: ::windows::core::PCWSTR, grfmode: P0, reserved1: u32, reserved2: u32) -> ::windows::core::Result<super::IStream>
    where
        P0: ::std::convert::Into<STGM>,
    {
        let mut result__ = ::core::mem::MaybeUninit::<*mut ::core::ffi::c_void>::zeroed();
    ...
    #[doc = "*Required features: `\"Win32_System_Com_StructuredStorage\"`*"]
    pub unsafe fn OpenStream<'a, P0>(&self, pwcsname: ::windows::core::PCWSTR, reserved1: *mut ::core::ffi::c_void, grfmode: P0, reserved2: u32, ppstm: *mut ::core::option::Option<super::IStream>) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<STGM>,
    {
    ...
    #[doc = "*Required features: `\"Win32_System_Com_StructuredStorage\"`*"]
    pub unsafe fn CreateStorage<'a, P0>(&self, pwcsname: ::windows::core::PCWSTR, grfmode: P0, reserved1: u32, reserved2: u32) -> ::windows::core::Result<IStorage>
    where
        P0: ::std::convert::Into<STGM>,
    {
        let mut result__ = ::core::mem::MaybeUninit::<*mut ::core::ffi::c_void>::zeroed();
    ...
    #[doc = "*Required features: `\"Win32_System_Com_StructuredStorage\"`*"]
    pub unsafe fn OpenStorage<'a, P0, P1>(&self, pwcsname: ::windows::core::PCWSTR, pstgpriority: P0, grfmode: P1, snbexclude: *const *const u16, reserved: u32) -> ::windows::core::Result<IStorage>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IStorage>>,
    ...
    #[doc = "*Required features: `\"Win32_System_Com_StructuredStorage\"`*"]
    pub unsafe fn MoveElementTo<'a, P0, P1>(&self, pwcsname: ::windows::core::PCWSTR, pstgdest: P0, pwcsnewname: ::windows::core::PCWSTR, grfflags: P1) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IStorage>>,
        P1: ::std::convert::Into<STGMOVE>,
    {
...
#[doc = "*Required features: `\"Win32_System_Com_StructuredStorage\"`*"]
#[inline]
pub unsafe fn StgCreateDocfile<'a, P0>(pwcsname: ::windows::core::PCWSTR, grfmode: P0, reserved: u32) -> ::windows::core::Result<IStorage>
where
    P0: ::std::convert::Into<STGM>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[inline]
pub unsafe fn StgCreateStorageEx<'a, P0, P1, P2>(pwcsname: ::windows::core::PCWSTR, grfmode: P0, stgfmt: P1, grfattrs: u32, pstgoptions: *mut STGOPTIONS, psecuritydescriptor: P2, riid: *const ::windows::core::GUID, ppobjectopen: *mut *mut ::core::ffi::c_void) -> ::windows::core::Result<()>
where
    P0: ::std::convert::Into<STGM>,
    P1: ::std::convert::Into<STGFMT>,
    P2: ::std::convert::Into<super::super::super::Security::PSECURITY_DESCRIPTOR>,
{
    #[cfg_attr(windows, link(name = "windows"))]
    extern "system" {
...
#[doc = "*Required features: `\"Win32_System_Com_StructuredStorage\"`*"]
#[inline]
pub unsafe fn StgOpenStorage<'a, P0, P1>(pwcsname: ::windows::core::PCWSTR, pstgpriority: P0, grfmode: P1, snbexclude: *const *const u16, reserved: u32) -> ::windows::core::Result<IStorage>
where
    P0: ::std::convert::Into<::windows::core::InParam<'a, IStorage>>,
    P1: ::std::convert::Into<STGM>,
{
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn StgOpenStorageEx<'a, P0, P1, P2>(pwcsname: ::windows::core::PCWSTR, grfmode: P0, stgfmt: P1, grfattrs: u32, pstgoptions: *mut STGOPTIONS, psecuritydescriptor: P2, riid: *const ::windows::core::GUID, ppobjectopen: *mut *mut ::core::ffi::c_void) -> ::windows::core::Result<()>
where
    P0: ::std::convert::Into<STGM>,
    P1: ::std::convert::Into<STGFMT>,
    P2: ::std::convert::Into<super::super::super::Security::PSECURITY_DESCRIPTOR>,
...
#[doc = "*Required features: `\"Win32_System_Com_StructuredStorage\"`*"]
#[inline]
pub unsafe fn WriteFmtUserTypeStg<'a, P0>(pstg: P0, cf: u16, lpszusertype: ::windows::core::PCWSTR) -> ::windows::core::Result<()>
where
    P0: ::std::convert::Into<::windows::core::InParam<'a, IStorage>>,
{
    #[cfg_attr(windows, link(name = "windows"))]
