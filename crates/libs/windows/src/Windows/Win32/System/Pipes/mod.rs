...
#[inline]
pub unsafe fn CreateNamedPipeA<'a, P0, P1>(lpname: ::windows::core::PCSTR, dwopenmode: P0, dwpipemode: P1, nmaxinstances: u32, noutbuffersize: u32, ninbuffersize: u32, ndefaulttimeout: u32, lpsecurityattributes: *const super::super::Security::SECURITY_ATTRIBUTES) -> ::windows::core::Result<super::super::Foundation::HANDLE>
where
    P0: ::std::convert::Into<super::super::Storage::FileSystem::FILE_FLAGS_AND_ATTRIBUTES>,
    P1: ::std::convert::Into<NAMED_PIPE_MODE>,
{
    #[cfg_attr(windows, link(name = "windows"))]
    extern "system" {
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security", feature = "Win32_Storage_FileSystem"))]
#[inline]
pub unsafe fn CreateNamedPipeW<'a, P0, P1>(lpname: ::windows::core::PCWSTR, dwopenmode: P0, dwpipemode: P1, nmaxinstances: u32, noutbuffersize: u32, ninbuffersize: u32, ndefaulttimeout: u32, lpsecurityattributes: *const super::super::Security::SECURITY_ATTRIBUTES) -> super::super::Foundation::HANDLE
where
    P0: ::std::convert::Into<super::super::Storage::FileSystem::FILE_FLAGS_AND_ATTRIBUTES>,
    P1: ::std::convert::Into<NAMED_PIPE_MODE>,
{
