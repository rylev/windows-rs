...
#[inline]
pub unsafe fn BackupEventLogA<'a, P0>(heventlog: P0, lpbackupfilename: ::windows::core::PCSTR) -> super::super::Foundation::BOOL
where
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn BackupEventLogW<'a, P0>(heventlog: P0, lpbackupfilename: ::windows::core::PCWSTR) -> super::super::Foundation::BOOL
where
    P0: ::std::convert::Into<EventLogHandle>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ClearEventLogA<'a, P0>(heventlog: P0, lpbackupfilename: ::windows::core::PCSTR) -> super::super::Foundation::BOOL
where
    P0: ::std::convert::Into<EventLogHandle>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ClearEventLogW<'a, P0>(heventlog: P0, lpbackupfilename: ::windows::core::PCWSTR) -> super::super::Foundation::BOOL
where
    P0: ::std::convert::Into<EventLogHandle>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn EvtSubscribe<'a, P0>(session: isize, signalevent: P0, channelpath: ::windows::core::PCWSTR, query: ::windows::core::PCWSTR, bookmark: isize, context: *const ::core::ffi::c_void, callback: EVT_SUBSCRIBE_CALLBACK, flags: u32) -> isize
where
