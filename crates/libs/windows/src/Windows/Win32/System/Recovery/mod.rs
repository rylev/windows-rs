...
#[doc = "*Required features: `\"Win32_System_Recovery\"`*"]
#[inline]
pub unsafe fn RegisterApplicationRestart<'a, P0>(pwzcommandline: ::windows::core::PCWSTR, dwflags: P0) -> ::windows::core::Result<()>
where
    P0: ::std::convert::Into<REGISTER_APPLICATION_RESTART_FLAGS>,
{
    #[cfg_attr(windows, link(name = "windows"))]
    extern "system" {
