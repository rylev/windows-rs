...
impl IExtendTaskPad {
    ...
    #[doc = "*Required features: `\"Win32_System_Mmc\"`, `\"Win32_System_Com\"`*"]
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn EnumTasks<'a, P0>(&self, pdo: P0, sztaskgroup: ::windows::core::PCWSTR) -> ::windows::core::Result<IEnumTASK>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, super::Com::IDataObject>>,
    {
        let mut result__ = ::core::mem::MaybeUninit::<*mut ::core::ffi::c_void>::zeroed();
...
impl IPropertySheetProvider {
    #[doc = "*Required features: `\"Win32_System_Mmc\"`, `\"Win32_System_Com\"`*"]
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreatePropertySheet<'a, P0>(&self, title: ::windows::core::PCWSTR, r#type: u8, cookie: isize, pidataobjectm: P0, dwoptions: u32) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, super::Com::IDataObject>>,
    {
