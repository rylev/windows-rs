...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn EcGetSubscriptionRunTimeStatus<'a, P0>(subscriptionname: ::windows::core::PCWSTR, statusinfoid: P0, eventsourcename: ::windows::core::PCWSTR, flags: u32, statusvaluebuffersize: u32, statusvaluebuffer: *mut EC_VARIANT, statusvaluebufferused: *mut u32) -> super::super::Foundation::BOOL
where
    P0: ::std::convert::Into<EC_SUBSCRIPTION_RUNTIME_STATUS_INFO_ID>,
{
    #[cfg_attr(windows, link(name = "windows"))]
    extern "system" {
