...
impl ITaskScheduler {
    ...
    #[doc = "*Required features: `\"Win32_System_TaskScheduler\"`*"]
    pub unsafe fn AddWorkItem<'a, P0>(&self, pwsztaskname: ::windows::core::PCWSTR, pworkitem: P0) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IScheduledWorkItem>>,
    {
