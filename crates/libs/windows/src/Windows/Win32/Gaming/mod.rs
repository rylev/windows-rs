...
impl IGameExplorer2 {
    #[doc = "*Required features: `\"Win32_Gaming\"`*"]
    pub unsafe fn InstallGame<'a, P0>(&self, binarygdfpath: ::windows::core::PCWSTR, installdirectory: ::windows::core::PCWSTR, installscope: P0) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<GAME_INSTALL_SCOPE>,
    {
...
impl IGameStatisticsMgr {
    #[doc = "*Required features: `\"Win32_Gaming\"`*"]
    pub unsafe fn GetGameStatistics<'a, P0>(&self, gdfbinarypath: ::windows::core::PCWSTR, opentype: P0, popenresult: *mut GAMESTATS_OPEN_RESULT, ppistats: *mut ::core::option::Option<IGameStatistics>) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<GAMESTATS_OPEN_TYPE>,
    {
...
impl IXblIdpAuthManager {
    ...
    #[doc = "*Required features: `\"Win32_Gaming\"`, `\"Win32_Foundation\"`*"]
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetTokenAndSignatureWithTokenResult<'a, P0>(&self, msaaccountid: ::windows::core::PCWSTR, appsid: ::windows::core::PCWSTR, msatarget: ::windows::core::PCWSTR, msapolicy: ::windows::core::PCWSTR, httpmethod: ::windows::core::PCWSTR, uri: ::windows::core::PCWSTR, headers: ::windows::core::PCWSTR, body: &[u8], forcerefresh: P0) -> ::windows::core::Result<IXblIdpAuthTokenResult>
    where
        P0: ::std::convert::Into<super::Foundation::BOOL>,
    {
