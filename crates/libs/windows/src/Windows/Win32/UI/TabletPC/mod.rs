...
#[doc = "*Required features: `\"Win32_UI_TabletPC\"`*"]
#[inline]
pub unsafe fn AddWordsToWordList<'a, P0>(hwl: P0, pwcwords: ::windows::core::PCWSTR) -> ::windows::core::Result<()>
where
...
#[doc = "*Required features: `\"Win32_UI_TabletPC\"`*"]
#[inline]
pub unsafe fn IsStringSupported<'a, P0>(hrc: P0, wcstring: u32, pwcstring: ::windows::core::PCWSTR) -> ::windows::core::Result<()>
where
    P0: ::std::convert::Into<HRECOCONTEXT>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[doc = "*Required features: `\"Win32_UI_TabletPC\"`*"]
#[inline]
pub unsafe fn MakeWordList<'a, P0>(hrec: P0, pbuffer: ::windows::core::PCWSTR, phwl: *mut HRECOWORDLIST) -> ::windows::core::Result<()>
where
    P0: ::std::convert::Into<HRECOGNIZER>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[doc = "*Required features: `\"Win32_UI_TabletPC\"`*"]
#[inline]
pub unsafe fn SetFactoid<'a, P0>(hrc: P0, cwcfactoid: u32, pwcfactoid: ::windows::core::PCWSTR) -> ::windows::core::Result<()>
where
    P0: ::std::convert::Into<HRECOCONTEXT>,
{
    #[cfg_attr(windows, link(name = "windows"))]
