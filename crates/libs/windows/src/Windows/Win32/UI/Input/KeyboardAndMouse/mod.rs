...
#[cfg(feature = "Win32_UI_TextServices")]
#[inline]
pub unsafe fn LoadKeyboardLayoutA<'a, P0>(pwszklid: ::windows::core::PCSTR, flags: P0) -> ::windows::core::Result<super::super::TextServices::HKL>
where
    P0: ::std::convert::Into<ACTIVATE_KEYBOARD_LAYOUT_FLAGS>,
{
    #[cfg_attr(windows, link(name = "windows"))]
    extern "system" {
...
#[cfg(feature = "Win32_UI_TextServices")]
#[inline]
pub unsafe fn LoadKeyboardLayoutW<'a, P0>(pwszklid: ::windows::core::PCWSTR, flags: P0) -> ::windows::core::Result<super::super::TextServices::HKL>
where
    P0: ::std::convert::Into<ACTIVATE_KEYBOARD_LAYOUT_FLAGS>,
{
    #[cfg_attr(windows, link(name = "windows"))]
