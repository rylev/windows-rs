...
impl IMbnConnection {
    ...
    #[doc = "*Required features: `\"Win32_NetworkManagement_MobileBroadband\"`*"]
    pub unsafe fn Connect<'a, P0>(&self, connectionmode: P0, strprofile: ::windows::core::PCWSTR) -> ::windows::core::Result<u32>
    where
...
impl IMbnConnectionContext {
    ...
    #[doc = "*Required features: `\"Win32_NetworkManagement_MobileBroadband\"`, `\"Win32_Foundation\"`*"]
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn SetProvisionedContext<'a, P0>(&self, provisionedcontexts: P0, providerid: ::windows::core::PCWSTR) -> ::windows::core::Result<u32>
    where
...
impl IMbnConnectionProfileManager {
    ...
    #[doc = "*Required features: `\"Win32_NetworkManagement_MobileBroadband\"`*"]
    pub unsafe fn GetConnectionProfile<'a, P0>(&self, mbninterface: P0, profilename: ::windows::core::PCWSTR) -> ::windows::core::Result<IMbnConnectionProfile>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IMbnInterface>>,
    {
        let mut result__ = ::core::mem::MaybeUninit::<*mut ::core::ffi::c_void>::zeroed();
...
impl IMbnRegistration {
    ...
    #[doc = "*Required features: `\"Win32_NetworkManagement_MobileBroadband\"`*"]
    pub unsafe fn SetRegisterMode<'a, P0>(&self, registermode: P0, providerid: ::windows::core::PCWSTR, dataclass: u32) -> ::windows::core::Result<u32>
    where
...
impl IMbnSms {
    ...
    #[doc = "*Required features: `\"Win32_NetworkManagement_MobileBroadband\"`, `\"Win32_System_Com\"`*"]
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn SmsSendCdma<'a, P0, P1>(&self, address: ::windows::core::PCWSTR, encoding: P0, language: P1, sizeincharacters: u32, message: *const super::super::System::Com::SAFEARRAY) -> ::windows::core::Result<u32>
    where
        P0: ::std::convert::Into<MBN_SMS_CDMA_ENCODING>,
        P1: ::std::convert::Into<MBN_SMS_CDMA_LANG>,
    {
        let mut result__ = ::core::mem::MaybeUninit::<u32>::zeroed();
