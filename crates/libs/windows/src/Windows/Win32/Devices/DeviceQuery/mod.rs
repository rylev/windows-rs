...
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn DevCreateObjectQueryFromId<'a, P0>(objecttype: P0, pszobjectid: ::windows::core::PCWSTR, queryflags: u32, prequestedproperties: &[super::Properties::DEVPROPCOMPKEY], pfilter: &[DEVPROP_FILTER_EXPRESSION], pcallback: PDEV_QUERY_RESULT_CALLBACK, pcontext: *const ::core::ffi::c_void) -> ::windows::core::Result<*mut HDEVQUERY__>
where
    P0: ::std::convert::Into<DEV_OBJECT_TYPE>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn DevCreateObjectQueryFromIdEx<'a, P0>(objecttype: P0, pszobjectid: ::windows::core::PCWSTR, queryflags: u32, prequestedproperties: &[super::Properties::DEVPROPCOMPKEY], pfilter: &[DEVPROP_FILTER_EXPRESSION], pextendedparameters: &[DEV_QUERY_PARAMETER], pcallback: PDEV_QUERY_RESULT_CALLBACK, pcontext: *const ::core::ffi::c_void) -> ::windows::core::Result<*mut HDEVQUERY__>
where
    P0: ::std::convert::Into<DEV_OBJECT_TYPE>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn DevCreateObjectQueryFromIds<'a, P0>(objecttype: P0, pszzobjectids: ::windows::core::PCWSTR, queryflags: u32, prequestedproperties: &[super::Properties::DEVPROPCOMPKEY], pfilter: &[DEVPROP_FILTER_EXPRESSION], pcallback: PDEV_QUERY_RESULT_CALLBACK, pcontext: *const ::core::ffi::c_void) -> ::windows::core::Result<*mut HDEVQUERY__>
where
    P0: ::std::convert::Into<DEV_OBJECT_TYPE>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn DevCreateObjectQueryFromIdsEx<'a, P0>(objecttype: P0, pszzobjectids: ::windows::core::PCWSTR, queryflags: u32, prequestedproperties: &[super::Properties::DEVPROPCOMPKEY], pfilter: &[DEVPROP_FILTER_EXPRESSION], pextendedparameters: &[DEV_QUERY_PARAMETER], pcallback: PDEV_QUERY_RESULT_CALLBACK, pcontext: *const ::core::ffi::c_void) -> ::windows::core::Result<*mut HDEVQUERY__>
where
    P0: ::std::convert::Into<DEV_OBJECT_TYPE>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn DevFindProperty<'a, P0>(pkey: *const super::Properties::DEVPROPKEY, store: P0, pszlocalename: ::windows::core::PCWSTR, pproperties: &[super::Properties::DEVPROPERTY]) -> *mut super::Properties::DEVPROPERTY
where
...
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn DevGetObjectProperties<'a, P0>(objecttype: P0, pszobjectid: ::windows::core::PCWSTR, queryflags: u32, prequestedproperties: &[super::Properties::DEVPROPCOMPKEY], pcpropertycount: *mut u32, ppproperties: *mut *mut super::Properties::DEVPROPERTY) -> ::windows::core::Result<()>
where
    P0: ::std::convert::Into<DEV_OBJECT_TYPE>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn DevGetObjectPropertiesEx<'a, P0>(objecttype: P0, pszobjectid: ::windows::core::PCWSTR, queryflags: u32, prequestedproperties: &[super::Properties::DEVPROPCOMPKEY], pextendedparameters: &[DEV_QUERY_PARAMETER], pcpropertycount: *mut u32, ppproperties: *mut *mut super::Properties::DEVPROPERTY) -> ::windows::core::Result<()>
where
    P0: ::std::convert::Into<DEV_OBJECT_TYPE>,
{
    #[cfg_attr(windows, link(name = "windows"))]
