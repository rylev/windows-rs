...
impl IUPnPServiceCallback {
    #[doc = "*Required features: `\"Win32_Devices_Enumeration_Pnp\"`, `\"Win32_Foundation\"`, `\"Win32_System_Com\"`, `\"Win32_System_Ole\"`*"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
    pub unsafe fn StateVariableChanged<'a, P0, P1>(&self, pus: P0, pcwszstatevarname: ::windows::core::PCWSTR, vavalue: P1) -> ::windows::core::Result<()>
    where
...
#[inline]
pub unsafe fn SwDeviceInterfacePropertySet<'a, P0>(hswdevice: P0, pszdeviceinterfaceid: ::windows::core::PCWSTR, pproperties: &[super::super::Properties::DEVPROPERTY]) -> ::windows::core::Result<()>
where
    P0: ::std::convert::Into<HSWDEVICE>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[inline]
pub unsafe fn SwDeviceInterfaceRegister<'a, P0, P1>(hswdevice: P0, pinterfaceclassguid: *const ::windows::core::GUID, pszreferencestring: ::windows::core::PCWSTR, pproperties: &[super::super::Properties::DEVPROPERTY], fenabled: P1) -> ::windows::core::Result<::windows::core::PWSTR>
where
    P0: ::std::convert::Into<HSWDEVICE>,
    P1: ::std::convert::Into<super::super::super::Foundation::BOOL>,
{
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn SwDeviceInterfaceSetState<'a, P0, P1>(hswdevice: P0, pszdeviceinterfaceid: ::windows::core::PCWSTR, fenabled: P1) -> ::windows::core::Result<()>
where
    P0: ::std::convert::Into<HSWDEVICE>,
    P1: ::std::convert::Into<super::super::super::Foundation::BOOL>,
{
