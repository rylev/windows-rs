...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn CommConfigDialogA<'a, P0>(lpszname: ::windows::core::PCSTR, hwnd: P0, lpcc: *mut COMMCONFIG) -> super::super::Foundation::BOOL
where
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn CommConfigDialogW<'a, P0>(lpszname: ::windows::core::PCWSTR, hwnd: P0, lpcc: *mut COMMCONFIG) -> super::super::Foundation::BOOL
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    #[cfg_attr(windows, link(name = "windows"))]
