...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security_Cryptography_Catalog"))]
#[inline]
pub unsafe fn CryptSIPPutSignedDataMsg<'a, P0>(psubjectinfo: *mut SIP_SUBJECTINFO, dwencodingtype: P0, pdwindex: *mut u32, cbsigneddatamsg: u32, pbsigneddatamsg: *mut u8) -> super::super::super::Foundation::BOOL
where
    P0: ::std::convert::Into<super::CERT_QUERY_ENCODING_TYPE>,
{
    #[cfg_attr(windows, link(name = "windows"))]
    extern "system" {
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn CryptSIPRetrieveSubjectGuid<'a, P0>(filename: ::windows::core::PCWSTR, hfilein: P0, pgsubject: *mut ::windows::core::GUID) -> super::super::super::Foundation::BOOL
where
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn CryptSIPRetrieveSubjectGuidForCatalogFile<'a, P0>(filename: ::windows::core::PCWSTR, hfilein: P0, pgsubject: *mut ::windows::core::GUID) -> super::super::super::Foundation::BOOL
where
    P0: ::std::convert::Into<super::super::super::Foundation::HANDLE>,
{
    #[cfg_attr(windows, link(name = "windows"))]
