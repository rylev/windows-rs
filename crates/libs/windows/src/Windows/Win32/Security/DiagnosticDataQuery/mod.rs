...
#[doc = "*Required features: `\"Win32_Security_DiagnosticDataQuery\"`*"]
#[inline]
pub unsafe fn DdqExtractDiagnosticReport<'a, P0>(hsession: P0, reportstoretype: u32, reportkey: ::windows::core::PCWSTR, destinationpath: ::windows::core::PCWSTR) -> ::windows::core::Result<()>
where
    P0: ::std::convert::Into<super::HDIAGNOSTIC_DATA_QUERY_SESSION>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[doc = "*Required features: `\"Win32_Security_DiagnosticDataQuery\"`*"]
#[inline]
pub unsafe fn DdqGetDiagnosticRecordLocaleTags<'a, P0>(hsession: P0, locale: ::windows::core::PCWSTR) -> ::windows::core::Result<super::HDIAGNOSTIC_EVENT_TAG_DESCRIPTION>
where
    P0: ::std::convert::Into<super::HDIAGNOSTIC_DATA_QUERY_SESSION>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[doc = "*Required features: `\"Win32_Security_DiagnosticDataQuery\"`*"]
#[inline]
pub unsafe fn DdqGetDiagnosticRecordProducerCategories<'a, P0>(hsession: P0, producername: ::windows::core::PCWSTR) -> ::windows::core::Result<super::HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION>
where
    P0: ::std::convert::Into<super::HDIAGNOSTIC_DATA_QUERY_SESSION>,
{
    #[cfg_attr(windows, link(name = "windows"))]
