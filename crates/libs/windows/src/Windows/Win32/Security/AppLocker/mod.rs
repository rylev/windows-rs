...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn SaferRecordEventLogEntry<'a, P0>(hlevel: P0, sztargetpath: ::windows::core::PCWSTR, lpreserved: *mut ::core::ffi::c_void) -> super::super::Foundation::BOOL
where
    P0: ::std::convert::Into<super::SAFER_LEVEL_HANDLE>,
{
    #[cfg_attr(windows, link(name = "windows"))]
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn SaferiIsExecutableFileType<'a, P0>(szfullpathname: ::windows::core::PCWSTR, bfromshellexecute: P0) -> super::super::Foundation::BOOL
where
