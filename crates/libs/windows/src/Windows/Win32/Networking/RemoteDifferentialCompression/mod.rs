...
impl ISimilarity {
    #[doc = "*Required features: `\"Win32_Networking_RemoteDifferentialCompression\"`, `\"Win32_Foundation\"`*"]
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn CreateTable<'a, P0>(&self, path: ::windows::core::PCWSTR, truncate: P0, securitydescriptor: *const u8, recordsize: u32) -> ::windows::core::Result<RdcCreatedTables>
    where
        P0: ::std::convert::Into<super::super::Foundation::BOOL>,
    {
...
impl ISimilarityTraitsTable {
    #[doc = "*Required features: `\"Win32_Networking_RemoteDifferentialCompression\"`, `\"Win32_Foundation\"`*"]
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn CreateTable<'a, P0>(&self, path: ::windows::core::PCWSTR, truncate: P0, securitydescriptor: *const u8) -> ::windows::core::Result<RdcCreatedTables>
    where
        P0: ::std::convert::Into<super::super::Foundation::BOOL>,
    {
        let mut result__ = ::core::mem::MaybeUninit::<RdcCreatedTables>::zeroed();
