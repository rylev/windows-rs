...
#[doc = "*Required features: `\"Win32_Networking_WebSocket\"`*"]
#[inline]
pub unsafe fn WebSocketBeginServerHandshake<'a, P0>(hwebsocket: P0, pszsubprotocolselected: ::windows::core::PCSTR, pszextensionselected: &[::windows::core::PSTR], prequestheaders: &[WEB_SOCKET_HTTP_HEADER], presponseheaders: *mut *mut WEB_SOCKET_HTTP_HEADER, pulresponseheadercount: *mut u32) -> ::windows::core::Result<()>
where
    P0: ::std::convert::Into<WEB_SOCKET_HANDLE>,
{
    #[cfg_attr(windows, link(name = "windows"))]
