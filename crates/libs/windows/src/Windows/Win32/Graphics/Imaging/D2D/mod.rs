...
impl IWICImagingFactory2 {
    #[doc = "*Required features: `\"Win32_Graphics_Imaging_D2D\"`*"]
    pub unsafe fn CreateDecoderFromFilename<'a, P0>(&self, wzfilename: ::windows::core::PCWSTR, pguidvendor: *const ::windows::core::GUID, dwdesiredaccess: u32, metadataoptions: P0) -> ::windows::core::Result<super::IWICBitmapDecoder>
    where
