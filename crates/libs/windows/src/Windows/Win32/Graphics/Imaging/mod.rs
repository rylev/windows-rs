...
impl IWICComponentFactory {
    #[doc = "*Required features: `\"Win32_Graphics_Imaging\"`*"]
    pub unsafe fn CreateDecoderFromFilename<'a, P0>(&self, wzfilename: ::windows::core::PCWSTR, pguidvendor: *const ::windows::core::GUID, dwdesiredaccess: u32, metadataoptions: P0) -> ::windows::core::Result<IWICBitmapDecoder>
    where
